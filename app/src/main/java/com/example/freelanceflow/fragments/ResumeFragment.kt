...
import com.example.freelanceflow.databinding.FragmentResumeBinding
...
//        val image = Image(imageData)
        ...
        val name = Paragraph(resumeBinding.personName.text.toString()).setBold().setFontSize(30f)
            .setTextAlignment(
                TextAlignment.CENTER
            )
        val email = Paragraph(resumeBinding.yourEmail.text.toString()).setBold().setFontSize(24f)
        ...
        introTable.addCell(
            Cell().setBackgroundColor(ColorConstants.BLUE).setBorder(introTableBorder)
                .add(Paragraph("Introduction").setFontColor(ColorConstants.WHITE).setFontSize(20f))
        )
        introTable.addCell(
            Cell().setBorder(introTableBorder)
                .add(Paragraph(resumeBinding.introText.text.toString()).setFontSize(20f))
        )
        ...
        educationTable.addCell(
            Cell().setBackgroundColor(ColorConstants.BLUE).setBorder(introTableBorder).add(
                Paragraph("Eduction Details").setFontSize(20f).setFontColor(ColorConstants.WHITE)
            )
        )
        ...
        educationDetailsTable.addCell(
            Cell().setBorder(introTableBorder).add(
                Paragraph("Middle School: ${resumeBinding.middleSchool.text}").setFontSize(20f)
                    .setBold()
            )
        )
        educationDetailsTable.addCell(
            Cell().setBorder(introTableBorder).add(
                Paragraph("Secured ${resumeBinding.middleSchoolPercentage.text}% in Class 10th").setFontSize(
                    20f
                )
            )
        )
        ...
        educationDetailsTable.addCell(
            Cell().setBorder(introTableBorder).add(
                Paragraph("High School: ${resumeBinding.highSchool.text}").setFontSize(20f)
                    .setBold()
            )
        )
        educationDetailsTable.addCell(
            Cell().setBorder(introTableBorder).add(
                Paragraph("Secured ${resumeBinding.highSchoolPercentage.text}% in Class 12th").setFontSize(
                    20f
                )
            )
        )
        ...
        educationDetailsTable.addCell(
            Cell().setBorder(introTableBorder).add(
                Paragraph("College: ${resumeBinding.highSchool.text}").setFontSize(20f).setBold()
            )
        )
        educationDetailsTable.addCell(
            Cell().setBorder(introTableBorder).add(
                Paragraph("Secured aggregate ${resumeBinding.highSchoolPercentage.text} CGPA in college").setFontSize(
                    20f
                )
            )
        )
        ...
        experienceTable.addCell(
            Cell().setBackgroundColor(ColorConstants.BLUE).setBorder(introTableBorder)
                .add(Paragraph("Experience").setFontSize(20f).setFontColor(ColorConstants.WHITE))
        )
        val expDetailsTableWidth = floatArrayOf(PageSize.A4.width)
        val expDetailsTable = Table(expDetailsTableWidth)
        // First Company
        expDetailsTable.addCell(
            Cell().setBorder(introTableBorder).add(
                Paragraph(" ${resumeBinding.companyName.text} - ${resumeBinding.companyPosition.text}").setFontSize(
                    20f
                ).setBold()
            )
        )
        expDetailsTable.addCell(
            Cell().setBorder(introTableBorder)
                .add(Paragraph(" ${resumeBinding.companyExp.text}").setFontSize(16f))
        )
        // Second Company
        expDetailsTable.addCell(
            Cell().setBorder(introTableBorder).add(
                Paragraph(" ${resumeBinding.company2Name.text} - ${resumeBinding.company2Position.text}").setFontSize(
                    20f
                ).setBold()
            )
        )
        expDetailsTable.addCell(
            Cell().setBorder(introTableBorder)
                .add(Paragraph(" ${resumeBinding.company2Exp.text}").setFontSize(16f))
        )
        ...
        projectTable.addCell(
            Cell().setBackgroundColor(ColorConstants.BLUE).setBorder(introTableBorder)
                .add(Paragraph("Projects").setFontSize(20f).setFontColor(ColorConstants.WHITE))
        )
        val projectDetailsTableWidth = floatArrayOf(PageSize.A4.width)
        val projectDetailsTable = Table(projectDetailsTableWidth)
        // First Project
        projectDetailsTable.addCell(
            Cell().setBorder(introTableBorder).add(
                Paragraph(" ${resumeBinding.projectName.text} - ${resumeBinding.project2Code.text}").setFontSize(
                    20f
                ).setBold()
            )
        )
        projectDetailsTable.addCell(
            Cell().setBorder(introTableBorder)
                .add(Paragraph(" ${resumeBinding.projectDesc.text}").setFontSize(16f))
        )
        // Second Project
        projectDetailsTable.addCell(
            Cell().setBorder(introTableBorder).add(
                Paragraph(" ${resumeBinding.project2Name.text} - ${resumeBinding.project2Code.text}").setFontSize(
                    20f
                ).setBold()
            )
        )
        projectDetailsTable.addCell(
            Cell().setBorder(introTableBorder)
                .add(Paragraph(" ${resumeBinding.project2Desc.text}").setFontSize(16f))
        )
